...
f:write("\nrule compilec\n")
f:write("  command = $cc -std=c99 -Wall -Wextra -Wpedantic -Ithirdparty -g -O2 -DDEBUG -D_DEBUG -c $in -o $out\n")
f:write("  description = Compiling $in\n")
...
f:write("build "..builddir.."/obj/"..("starry/thirdparty.c"):gsub("%.c", ".o"):gsub("/", "_") ..
		": compilec ".."starry/thirdparty.c".."\n")
...
f:write(builddir.."/obj/"..("starry/thirdparty.c"):gsub("%.c", ".o"):gsub("/", "_"))
