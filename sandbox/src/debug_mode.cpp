...
void sbox::debug_mode()
{
	...
	// );
	// ImGui::BulletText("Position: %f, %f, %f", cam.position.x, cam.position.y,
	// cam.position.z); ImGui::BulletText("Rotation: %f, %f, %f", cam.rotation.x,
	// cam.rotation.y, cam.rotation.z); ImGui::BulletText(
